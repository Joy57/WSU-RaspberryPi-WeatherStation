...
sendEmail = async (triggered) =>{
    ...
    if(triggered.secondValue){
        var mailOptions = {
            ...
            'CPU Usage: ' + triggered.cpu_usage + '\n' +
            'RAM Usage: ' + triggered.ram_usage + '\n' +
            'Battery: ' + triggered.battery + '\n'
...
sendSMS = async (triggered) => {
    ...
    const client = await require('twilio')("ACb3a83adf61207d82409101e116b7dd03","9408eaea678ceac0b1033e4214c1e853");
        ...
        weather.map(weather => {
            if(triggered.keyword === 'above'){
                if((weather[triggered.type] > triggered.value) && (weather.station_name === triggered.station_name)){
                    ...
                    triggered.cpu_usage = weather.cpu_usage;
                    triggered.ram_usage = weather.ram_usage;
                    triggered.battery = weather.battery;
